...
This repo contains the complete SQL walkthrough for the blog post:
["We Lost Customers, But Not Revenue (Three churn definitions that explain it"](https://tivon.io/2026/02/15/we-lost-customers-but-not-revenue/) (published on tivon.io).

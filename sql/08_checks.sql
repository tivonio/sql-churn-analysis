...
PURPOSE:
    - Run reconciliation checks on the churn views before interpretation.
    - Spot join errors and duplicates.

Significance
    - SQL 08 is a validation check.
    - It ensures the analytical views are internally consistent.
    - This file is essential for reproducibility and debugging.

Dependencies
    - Requires:
        - v_revenue_waterfall_month (04_logo_churn.sql)
        - v_logo_churn_month (05_revenue_waterfall.sql)
